...
QString AddChr(const QString tx, const QChar c, const uint n, bool esq)     //  ln21
{
    if(tx.length() >= n)
    {
        if(esq)
...
QString AddChr(const QString tx, const QString c, const uint n, bool esq)     //  ln22
{
    if(tx.length() >= n)
    {
        if(esq)
...
QString Ignore(const QString tx, const QString exceto)     //  ln24
{
    QString r = "";
...
QString IgnoreEsquerda(const QString tx, const QString exceto)     //  ln25
{
    QString r = tx;
...
QString IgnoreDireita(const QString tx, const QString exceto)     //  ln26
{
    QString r = tx;
...
QString get_Id_Ln_Pnt(const QString ln)     //  ln28
{
...
QString get_Atr_Ln_Pnt(const QString ln)     //  ln29
{
    QString ig = TIPO_ALFA;
    ig += TIPO_NUM;
    ig += TIPO_LIGA;
...
double get_Abci_Ln_Pnt(const QString ln)     //  ln30
{
...
double get_Orde_Ln_Pnt(const QString ln)     //  ln31
{
...
double get_Cota_Ln_Pnt(const QString ln)     //  ln32
{
...
QString get_Va_Ln_Ars(const QString ln)     //  ln34
{
    QString ig = TIPO_ALFA;
    ig += TIPO_NUM;
    ig += TIPO_LIGA;
...
QString get_Vb_Ln_Ars(const QString ln)     //  ln35
{
    QString ig = TIPO_ALFA;
    ig += TIPO_NUM;
    ig += TIPO_LIGA;
...
QString get_Va_Ln_Fce(const QString ln)     //  ln37
{
    return get_Va_Ln_Ars(ln);
}

QString get_Vb_Ln_Fce(const QString ln)     //  ln38
{
    QString ig = TIPO_ALFA;
    ig += TIPO_NUM;
    ig += TIPO_LIGA;
...
QString get_Vc_Ln_Fce(const QString ln)     //  ln39
{
    return get_Vb_Ln_Ars(ln);
}

QString SeparaEntities(const QString arg)     //  ln41
{
...
bool LerPntDXl(QString &buf, QString &ln)     //  ln42
{
...
//  Arquivo
bool Importa(QString &buf, QString dir, QString filtro, QString titulo)     //  ln45
{
...
bool Importa(QString &buf, QString filtro, QString titulo)     //  ln46
{
    return Importa(buf, IDIR, filtro, titulo);
}

bool Exporta(QString &buf, QString dir, QString filtro, QString titulo)     //  ln47
{
...
bool Exporta(QString &buf, QString filtro, QString titulo)     //  ln48
{
...
SegReta::SegReta(const QString a, const QString b)
{
    va = a;
    vb = b;
}

SegReta::SegReta(const QString ln)
{
    va = get_Va_Ln_Ars(ln);
    vb = get_Vb_Ln_Ars(ln);
}

SegReta::SegReta(const SegReta &outra)
{
    va = outra.va;
    vb = outra.vb;
}
...
bool SegReta::operator ==(const SegReta outra)
{
    if(va == outra.va)
        return (vb == outra.vb);
    if(vb == outra.va)
...
Face::Face(const QString a, const QString b, const QString c)
{
    va = a;
    vb = b;
    vc = c;
